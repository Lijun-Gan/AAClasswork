...
View.prototype.exercise4 = function () {
  ...
  //your code here!
  const $name = $(".square:nth-child(odd)");
  $name.text("Lijun Gan");
};
...
View.prototype.exercise5 = function () {
  ...
  //your code here!
  $("li").on("click", event => {
    const $squareLi = $(event.currentTarget);
    const position = $squareLi.data("pos");
    alert(position)
  })
};
...
View.prototype.exercise6 = function () {
 ...
 $(".square").each(function(idx,el){
   let $e = $(el);
   $e.css("background-color",_randomColorString());
  });
...
View.prototype.exercise7 = function(){
  ...
  $items.on("mouseover", event =>{
    ...
    console.log(currentTarget.style.backgroundColor);
  })
