...
var fetchSearchGiphys = function fetchSearchGiphys(searchItem) {
  return function (dispatch) {
    _util_api_util__WEBPACK_IMPORTED_MODULE_0__["fetchSearchGiphys"](searchItem).then(function (giphys) {
...
function GiphysIndex(giphys) {
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, giphys.giphys.map(function (img, idx) {
...
function (_React$Component) {
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", null, "Search a Giphy", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
        type: "text",
        onChange: this.handleChange,
        value: this.state.searchItem
      })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", null, "Submit")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_giphys_index__WEBPACK_IMPORTED_MODULE_1__["default"], {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(react_redux__WEBPACK_IMPORTED_MODULE_0__["connect"])(mapStateToProps, mapDispathcToProps)(_giphys_search__WEBPACK_IMPORTED_MODULE_1__["default"]));
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: "GET",
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=", "Kp5xqNCXZQooS1IPeKAXyVZtkASB86Sz", "&limit=2")
  });
};
