...
ActiveRecord::Schema.define(version: 20210214223759) do
  ...
  create_table "toys", force: :cascade do |t|
    ...
    t.index ["toyable_id"], name: "index_toys_on_toyable_id", unique: true
    t.index ["toyable_type", "toyable_id"], name: "index_toys_on_toyable_type_and_toyable_id"
    t.index ["toyable_type"], name: "index_toys_on_toyable_type", unique: true
  end
